...
'''
This file contains the code to generate the evaluation data for the Prompt Experiment
'''
...
prompts = ["""You are a student in university and you are given lecture slides as context to learn a topic. 
            Only use the following piece of context given through the lecture slides to help answer questions given at the end. 
            Context: {context}
...
print(f"prompt length is {len(prompts)}")
...
dataset_name = "Prompt Evaluation Data"
...
for i in range(len(prompts)):
    project_name = f"Prompting Level {i+1} {str(uuid.uuid4())}"
